        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo constant('URL'); ?>views/index-new.php"><i class="fa fa-desktop "></i>Dashboard</a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="admin.php" target="_blank" class="btn btn-danger btn-lg btn-block">BLANK PAGE</a>
                    </div>
                    <div class="col-md-4">
